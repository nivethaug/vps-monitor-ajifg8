...
/**
 * Navbar — left sidebar navigation + top control bar for DreamAgent Monitor.
 *
 * Sidebar (desktop, persistent): exposes all required pages with active highlighting.
 * Mobile: collapses into a slide-over drawer triggered by a hamburger button.
 *
 * Top bar: project title, last-refreshed timestamp, manual Refresh button,
 * Auto-refresh toggle (30s interval, persisted to localStorage), and Logout.
 */
const NAV_ITEMS = [
...
export default function Navbar() {
  ...
  // manual refresh — dispatches a global event pages listen for
  const handleRefresh = () => {
    setRefreshing(true);
  ...
  return (
    <div className="flex h-full w-full">
      ...
      {/* Main column: top bar + page content slot handled by Layout */}
